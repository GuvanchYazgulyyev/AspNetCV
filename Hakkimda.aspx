<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Hakkimda.aspx.cs" Inherits="AspCV.Hakkimda" %>
    ...
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <div>
                ...
                <asp:TextBox ID="TextBox6" runat="server" CssClass="form-control" TextMode="MultiLine" Height="80"></asp:TextBox>
            </div>
            <br />
            <div>
