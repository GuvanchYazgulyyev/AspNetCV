<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="AspCV.Default" %>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            ...
            <span class="d-none d-lg-block">
                <asp:Repeater ID="Repeater7" runat="server">
                    <ItemTemplate>
                        ...
                        <img class="img-fluid img-profile rounded-circle mx-auto mb-2" width="200" height="400" src='<%# Eval("FOTOGRAF") %>' alt="">
                    </ItemTemplate>
                </asp:Repeater>
            </span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#education">Eğitiğm Hayatım</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container-fluid p-0">
                ...
                <ItemTemplate>
                    ...
                    <div class="my-auto">
                        ...
                        <div class="subheading mb-5">
                            ...
                            Mail:  <a href="mr.yazgulyyew@outlook.com">
                                <asp:Label ID="Label5" runat="server" Text='<%#Eval("MAIL") %>'></asp:Label></a><p></p>
                        </div>
                        <p class="lead mb-5">
                            Hakkımda:
                        ...
                        <div class="social-icons">
                            ...
                            <a href="https://twitter.com/Kvanc1009">
                                <i class="fab fa-twitter"></i>
                            </a>
                            <a href="https://www.facebook.com/guwanc.yazgulyyew.9">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a href="https://www.instagram.com/kivancyazgu/">
        ...
        <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="interests">
            <div class="my-auto">
                <h2 class="mb-5">İlgİ Alanlarım</h2>
                        ...
                        <ul class="fa-ul mb-0">
                            <p>
                                <li>
                                    ...
                                    <asp:Label ID="Label17" runat="server" Text='<%#Eval("SERTIFIKA") %>'>
                                    </asp:Label>
                                </li>
                            </p>
                        </ul>
